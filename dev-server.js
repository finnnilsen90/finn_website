...
let direct = require('./dev-server/directories.js');
...
const directories = require('./dev-server/directories.js')(app);
const sessionChecker = require('./dev-server/session_checker.js');
